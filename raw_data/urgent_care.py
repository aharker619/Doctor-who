# Alyssa Harker
# Original Code
# source: https://hifld-dhs-gii.opendata.arcgis.com/datasets/0d748999f5eb4e76a7e0389442381af6_0?geometry=-30.27%2C-0.777%2C166.253%2C71.723
...
def load_uc_data(save = False, output_file = ''):
    ...
    Input:
        save: boolean, whether to save the data as a csv
        output_file: str, filename to save
    Output:
        csv file with name output_file
    '''
    ...
    # fill in missing zeros in zipcodes
